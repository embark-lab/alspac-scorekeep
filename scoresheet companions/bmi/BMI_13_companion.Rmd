...
labelled::var_label(bmi_13$bmi_z_pr_2006.13)  <- 'BMI z-score based on parent-report BMI, using WHO 2006 BMI z-scoring'
...
labelled::var_label(bmi_14$bmi_z_pr_2006_14)  <- 'BMI z-score based on parent-report (puberty Q) BMI, using WHO 2006 BMI z-scoring - age 14'
bmi_14 <- bmi_14 %>%  
